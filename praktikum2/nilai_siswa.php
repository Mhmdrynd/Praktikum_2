...
function Predikat($nilai_akhir) {
  switch (true) {
    case $nilai_akhir >= 85 && $nilai_akhir <= 100:
      return '<h5 class="text-info">Sangat Memuaskan</h5><br><br><h1 class="text-danger">LULUS</h1>';
      break;
    case $nilai_akhir >= 70 && $nilai_akhir <= 84:
      return '<h5 class="text-info">Memuaskan</h5><br><br><h1 class="text-danger">LULUS</h1>';
      break;
    case $nilai_akhir >= 56 && $nilai_akhir <= 69:
      return '<h5 class="text-info">Cukup</h5><br><br><h1 class="text-danger">LULUS</h1>';
      break;
    case $nilai_akhir >= 36 && $nilai_akhir <= 55:
      return '<h5 class="text-info">Kurang</h5><br><br><h1 class="text-danger">TIDAK LULUS</h1>';
      break;
    case $nilai_akhir >= 0 && $nilai_akhir <= 35:
      return '<h5 class="text-info">Sangat Kurang</h5><br><br><h1 class="text-danger">TIDAK LULUS</h1>';  
      break;
    default:
      return '<h5>Tidak Ada</h5><br><br><h1 class="text-danger">TIDAK LULUS</h1>';
      break;
  }
}
?>
